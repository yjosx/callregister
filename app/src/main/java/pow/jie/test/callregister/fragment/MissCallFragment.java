...
public class MissCallFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        baseView = inflater.inflate(R.layout.fragment_miss_call, container, false);
        this.context = this.getActivity();
        RecyclerView recyclerView = baseView.findViewById(R.id.rv_miss_call);
    ...
    public static List<CallLogInfo> readCallLog(Context context) {
        ...
        List<CallLogInfo> callLogInfos = new ArrayList<CallLogInfo>();
        ...
        Cursor cursor = resolver.query
                (uri, projection, "type = ?", new String[]{"3"}, null);
