...
public class AnswerFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        baseView = inflater.inflate(R.layout.fragment_answer, container, false);
        this.context = this.getActivity();
        RecyclerView recyclerView = baseView.findViewById(R.id.rv_answer);
    ...
    public static List<CallLogInfo> readCallLog(Context context) {
        ...
        Cursor cursor = resolver.query
                (uri, projection, "type = ?", new String[]{"1"}, null);
